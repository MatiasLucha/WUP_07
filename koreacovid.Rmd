...
fisher.test(table1)
```
The p-value for the Chi-squared test is 0.001, so we reject the knull hypothesis.


## Conclusions
There is a relationship between gender or sex, and the amount of deaths in Korea during or due to Covid.
